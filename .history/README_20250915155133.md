...
| 脚本名称 | 描述 | 安装 | 更新日期 |
|---------|------|------|----------|
| 页面美化助手 v1.1.0 | 为网页添加暗黑模式、字体调节、阅读模式、广告屏蔽等功能，支持网站独立配置 | [安装](https://raw.githubusercontent.com/Lee-zg/qmsl/main/scripts/website-enhancement/page-beautifier.user.js) | 2025-01-15 |
