...
**安装方法**：
1. 点击 [安装链接](https://raw.githubusercontent.com/Lee-zg/qmsl/main/scripts/category/script-name.user.js)
2. 确认安装
3. 访问目标网站即可使用
...
**问题反馈**：
如果遇到问题，请在 [Issues](https://github.com/Lee-zg/qmsl/issues) 中反馈。
